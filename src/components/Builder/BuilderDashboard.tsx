  ...
  return (
    <Container maxWidth='xl' sx={{ py: { xs: 2, sm: 3, md: 4 } }}>
      ...
      >
        <Card
          elevation={3}
          sx={{ background: 'linear-gradient(135deg, #28a745 0%, #1e7e34 100%)' }}
        >
        ...
        <Card
          elevation={3}
          sx={{ background: 'linear-gradient(135deg, #dc3545 0%, #c82333 100%)' }}
        >
          <CardContent>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <Box>
      ...
      <Card
        elevation={3}
        sx={{ mb: 4, background: 'linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%)' }}
      >
        <CardContent>
                        ...
                        <Stack direction='row' spacing={1} justifyContent='center'>
                          ...
                          <Tooltip title='Analytics'>
                            <IconButton
                              size='small'
                              color='success'
                              onClick={() => setAnalyticsProperty(property)}
                            >
                              <Analytics />
                            </IconButton>
                          </Tooltip>
                            ...
                            <DialogActions>
                              ...
                              <Button
                                ...
                                onClick={async () => {
                                  ...
                                  try {
                                    ...
                                    const res = await fetch(
                                      `/api/property/${editPropertyForm._id || editPropertyForm.id}`,
                                      {
                                        method: 'PUT',
                                        headers,
                                        body: JSON.stringify({
                                ...
                                disabled={
                                  ...
                                  !editPropertyForm.type ||
                                  !editPropertyForm.location ||
                                  !editPropertyForm.area ||
                                  !editPropertyForm.pricePerSqft ||
                                  !editPropertyForm.totalUnits ||
                                  !editPropertyForm.configuration ||
                                  !editPropertyForm.amenities ||
                                  !editPropertyForm.completionDate
                                }
                              >
                                Save Changes
                              </Button>
                              ...
                              {analyticsProperty && (
                                <Stack spacing={2} sx={{ mt: 2 }}>
                                  <Typography variant='h6' fontWeight={600}>
                                    {analyticsProperty.name}
                                  </Typography>
                                  <Typography variant='body2'>
                                    Units Sold: {analyticsProperty.soldUnits}
                                  </Typography>
                                  <Typography variant='body2'>
                                    Available Units: {analyticsProperty.availableUnits}
                                  </Typography>
                                  <Typography variant='body2'>
                                    Total Units: {analyticsProperty.totalUnits}
                                  </Typography>
                                  <Typography variant='body2'>
                                    Lead Requests: {analyticsProperty.leadRequests}
                                  </Typography>
                                  <Typography variant='body2'>
                                    Completion Date: {analyticsProperty.completionDate}
                                  </Typography>
                ...
                <TableBody>
                  {leads.map(lead => (
                    <TableRow key={lead._id || lead.id}>
                      ...
                      <TableCell>
                        <Box>
                          <Typography variant='subtitle2'>{lead.customerName}</Typography>
                          <Typography variant='caption' sx={{ color: '#666' }}>
                            {lead.email}
                          </Typography>
                        </Box>
                      ...
                      <TableCell>
                        <Typography variant='subtitle2'>{lead.preferredLocation}</Typography>
                      </TableCell>
                      <TableCell>
                        <Typography
                          variant='subtitle2'
        ...
        <DialogContent>
          <Stack spacing={3} sx={{ mt: 2 }}>
            ...
            <TextField
              ...
              onChange={e =>
                setNewProperty({ ...newProperty, pricePerSqft: Number(e.target.value) })
              }
              required
            />
            <TextField
