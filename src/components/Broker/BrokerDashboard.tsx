        ...
        >
          ...
          <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', zIndex: 1 }}>
            <Button
              variant='contained'
              startIcon={
                loading ? <CircularProgress size={16} sx={{ color: 'white' }} /> : <Refresh />
              }
        ...
        <>
          ...
          >
            {[
              ...
              },
              {
                ...
                trend:
                  stats.conversionRate > 0 ? (stats.conversionRate >= 10 ? '+5%' : '-2%') : null,
              },
          ...
          <Box
            sx={{
              borderBottom: 1,
              borderColor:
                theme.palette.mode === 'dark' ? alpha(theme.palette.common.white, 0.1) : 'divider',
              mb: 3,
              background:
                theme.palette.mode === 'dark'
                  ? `linear-gradient(135deg, ${alpha(theme.palette.common.white, 0.05)} 0%, ${alpha(theme.palette.common.white, 0.02)} 100%)`
          ...
          >
            ...
            >
              <Tab label='Leads Management' icon={<People />} iconPosition='start' />
                          ...
                          filteredAndSortedLeads.map((lead: Lead, index: number) => (
                            ...
                            >
                              ...
                              >
                                ...
                                <TableCell>
                                  <Typography variant='caption'>{lead.propertyDetails}</Typography>
                                </TableCell>
                                <TableCell>
                                  <Chip
                                    ...
                                    sx={{
                                      animation:
                                        lead.status === 'new' ? 'pulse 2s infinite' : 'none',
                                      '@keyframes pulse': {
                                        '0%': { opacity: 1 },
                                        '50%': { opacity: 0.7 },
                                        '100%': { opacity: 1 },
                                ...
                                <TableCell align='center'>
                                  <Stack direction='row' spacing={1} justifyContent='center'>
                                    ...
                                    <Dialog
                                      open={editLeadDialog}
                                      onClose={() => setEditLeadDialog(false)}
                                      maxWidth='sm'
                                      fullWidth
                                    >
                                      ...
                                      <DialogContent>
                                        {selectedLead && (
                                          ...
                                          >
                                            <TextField
                                              label='Name'
                                              value={editLeadData.name ?? selectedLead.name}
                                              onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                                                setEditLeadData({
                                                  ...editLeadData,
                                                  name: e.target.value,
                                            ...
                                            <TextField
                                              label='Contact'
                                              value={editLeadData.contact ?? selectedLead.contact}
                                              onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                                                setEditLeadData({
                                                  ...editLeadData,
                                            ...
                                            <TextField
                                              ...
                                              type='number'
                                              value={
                                                editLeadData.loanAmount ?? selectedLead.loanAmount
                                              }
                                              onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                                                setEditLeadData({
                                                  ...editLeadData,
                                            ...
                                            <TextField
                                              label='Source'
                                              value={editLeadData.source ?? selectedLead.source}
                                              onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                                                setEditLeadData({
                                                  ...editLeadData,
                                            ...
                                            <FormControl fullWidth>
                                              ...
                                              <Select
                                                value={
                                                  editLeadData.priority ?? selectedLead.priority
                                                }
                                                label='Priority'
                                                onChange={(e: any) =>
                                                  setEditLeadData({
                                      ...
                                      <DialogActions>
                                        <Button onClick={() => setEditLeadDialog(false)}>
                                          Cancel
                                        </Button>
                      ...
                      <TableBody>
                        {analytics.topPerformingBanks.map((bank: any, index: number) => (
                          <TableRow key={index}>
                            ...
                            <TableCell align='center'>
                              <Typography variant='body2'>{bank.applications}</Typography>
                            </TableCell>
                            <TableCell align='center'>
                              <Typography
                                variant='body2'
                  ...
                  <Stack spacing={3}>
                    ...
                    <Box>
                      ...
                      <LinearProgress
                        variant='determinate'
                        value={
                          stats.totalLeads > 0 ? (stats.qualifiedLeads / stats.totalLeads) * 100 : 0
                        }
                        sx={{ height: 8, borderRadius: 4 }}
                        color='warning'
                      />
            ...
            <DialogContent>
              <Stack spacing={3} sx={{ mt: 2 }}>
                ...
                <TextField
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setNewLead({ ...newLead, loanAmount: Number(e.target.value) })
                  }
                  required
                />
                <TextField
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setNewLead({ ...newLead, propertyDetails: e.target.value })
                  }
                  required
                />
                <TextField
          ...
          <Dialog
            open={viewLeadDialog}
            onClose={() => setViewLeadDialog(false)}
            maxWidth='sm'
            fullWidth
          >
            ...
            <DialogContent>
              {selectedLead && (
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  ...
                  <Typography variant='body2'>
                    <strong>Loan Amount:</strong> ₹{selectedLead.loanAmount.toLocaleString()}
                  </Typography>
                  <Typography variant='body2'>
                    <strong>Property Details:</strong> {selectedLead.propertyDetails}
                  </Typography>
                  <Typography variant='body2'>
