...
import { TrendingUp, Calculate, PieChart } from '@mui/icons-material';
      ...
      >
        <Card
          ...
          sx={{
            ...
            border: theme =>
              theme.palette.mode === 'dark' ? '1px solid #333' : '1px solid #e3f2fd',
            overflow: 'hidden',
            height: '100%',
            minHeight: { md: '50vh' },
          }}
                ...
                <Stack spacing={1.5}>
                  <Paper
                    sx={{
                      ...
                      border: theme =>
                        theme.palette.mode === 'dark' ? '1px solid #444' : '1px solid #e0e0e0',
                    }}
                  >
                    <Typography
                      variant='body2'
                    ...
                    >
                      ...
                      <br />• Longer tenure = Lower EMI but higher interest
                    </Typography>
                  </Paper>
                  ...
                  >
                    ...
                    >
                      ...
                      <br />• Compare offers from multiple banks
                    </Typography>
                  </Paper>
                </Stack>
              </Box>
              ...
              <Box>
                ...
                >
                  ...
                  >
                    <Typography
                      variant='body2'
                      sx={{
                        color: theme => (theme.palette.mode === 'dark' ? '#ffffff' : '#e65100'),
                        mb: 1,
                        fontWeight: 600,
                      }}
                    >
                ...
                <Paper
                  sx={{
                    ...
                    border: theme =>
                      theme.palette.mode === 'dark' ? '2px solid #a855f7' : '2px solid #9c27b0',
                    mb: 2,
                  }}
                >
                  <Typography
                    variant='body2'
                    sx={{
                      color: theme => (theme.palette.mode === 'dark' ? '#ffffff' : '#7b1fa2'),
                      mb: 1,
                      fontWeight: 600,
                    }}
                  >
                  ...
                  <Typography
                    ...
                    sx={{
                      fontWeight: 700,
                      color: theme => (theme.palette.mode === 'dark' ? '#ffffff' : '#9c27b0'),
                    }}
                  >
