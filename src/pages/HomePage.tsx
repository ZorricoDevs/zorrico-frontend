...
const HomePage: React.FC = () => {
  ...
  const features = [
    {
      ...
      description: 'Compare rates from 50+ banks and NBFCs to find the most competitive home loan rates in the market.'
    },
    {
      icon: <Speed sx={{ fontSize: 40 }} />,
      title: 'Instant Approval',
      description: 'Get pre-approved in minutes with our AI-powered eligibility engine and fast-track documentation.'
    },
    {
      icon: <Security sx={{ fontSize: 40 }} />,
      title: 'Secure & Trusted',
      description: 'Bank-grade security with end-to-end encryption. Your financial data is safe with us.'
    },
    {
      icon: <Assignment sx={{ fontSize: 40 }} />,
      title: 'Minimal Documentation',
      description: 'Digital KYC and document verification. Upload docs online and get instant verification.'
    },
    {
      icon: <AccountBalance sx={{ fontSize: 40 }} />,
      title: 'Expert Guidance',
      description: 'Dedicated relationship managers to guide you through every step of your home loan journey.'
    },
    {
      icon: <Timeline sx={{ fontSize: 40 }} />,
      title: 'End-to-End Support',
      description: 'From application to disbursement, we provide complete assistance and track your loan progress.'
    }
  ];
  ...
  const loanTypes = [
    {
      title: 'Home Loan',
      description: 'Traditional home loan for purchasing your dream home with competitive interest rates',
      rate: '8.5% onwards',
    ...
    },
    {
      ...
      description: 'Stage-wise disbursement for homes under construction with flexible payment options',
      rate: '8.6% onwards',
  ...
  return (
    <Box ref={containerRef} sx={{ backgroundColor: 'var(--bg-primary)', color: 'var(--text-primary)', overflow: 'hidden' }}>
              ...
              <Box sx={{ flex: 1, maxWidth: '600px' }}>
                ...
                >
                  <Typography sx={{
                    ...
                    Compare home loans from 50+ banks and NBFCs. Get pre-approved in minutes
                    with India&apos;s most trusted home loan platform.
                  </Typography>
                </motion.div>
          ...
          <Container maxWidth="lg">
            ...
            >
              ...
              <Typography sx={{
                ...
                India&apos;s most trusted home loan platform with cutting-edge technology and personalized service
              </Typography>
            </motion.div>
          ...
          <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
            ...
            >
              ...
              <Typography variant="h6" sx={{
                ...
                Join thousands of satisfied customers who have found their perfect home loan through Mittra
              </Typography>
