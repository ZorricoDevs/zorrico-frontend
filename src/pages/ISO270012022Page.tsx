    ...
    <Container maxWidth='md'>
      <Paper elevation={3} sx={{ p: 4, borderRadius: 3 }}>
        ...
        <Typography variant='body1' sx={{ mb: 2 }}>
          Zorrico is committed to information security and is compliant with ISO 27001:2022
          standards. We ensure your data is handled with the utmost care and security.
        </Typography>
