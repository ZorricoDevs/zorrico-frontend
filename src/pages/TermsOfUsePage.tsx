    ...
    <Stack spacing={4}>
      ...
      <Paper elevation={2} sx={{ p: 4 }}>
        ...
        <Stack spacing={2}>
          ...
          <Typography variant="body2">
            • <strong>Application Processing:</strong> Facilitating loan applications and documentation
          </Typography>
          <Typography variant="body2">
            • <strong>Advisory Services:</strong> Providing loan-related guidance and support
          </Typography>
          <Typography variant="body2">
            • <strong>Tools & Calculators:</strong> Offering EMI calculators and eligibility checkers
          </Typography>
        </Stack>

        <Box sx={{ mt: 3, p: 2, backgroundColor: '#fff3cd', borderRadius: 1, border: '1px solid #ffeaa7' }}>
          <Typography variant="body2" sx={{ fontWeight: 600 }}>
            Important: HomeLoanMittra is a loan aggregator and technology platform. We do not lend money directly.
          </Typography>
        </Box>
      </Paper>
      ...
      <Paper elevation={2} sx={{ p: 4 }}>
        ...
        <Stack spacing={2}>
          ...
          <Typography variant="body2">
            • <strong>Lender Discretion:</strong> Final loan decisions rest with the respective lenders
          </Typography>
          <Typography variant="body2">
            • <strong>Documentation:</strong> You must provide accurate documents as requested
          </Typography>
          <Typography variant="body2">
            • <strong>Credit Checks:</strong> Lenders may perform credit checks that may affect your credit score
          </Typography>
          <Typography variant="body2">
            • <strong>Processing Time:</strong> Loan processing times depend on lender policies and documentation
          </Typography>
        </Stack>
      </Paper>
      ...
      <Paper elevation={2} sx={{ p: 4 }}>
        ...
        <Stack spacing={2}>
          <Typography variant="body2">
            • <strong>Platform Services:</strong> Our comparison and application services are free for customers
          </Typography>
          <Typography variant="body2">
            • <strong>Lender Charges:</strong> Processing fees, legal charges, and other costs are as per lender terms
          </Typography>
          <Typography variant="body2">
      ...
      <Box sx={{ textAlign: 'center', mt: 4 }}>
        <Typography variant="body2" sx={{ color: '#666' }}>
          By using our services, you acknowledge that you have read and understood these Terms of Use.
        </Typography>
      </Box>
    </Stack>
  );
