...
import { Typography, Stack, Box, Paper, Alert, useTheme } from '@mui/material';
    ...
    <Stack spacing={4}>
      ...
      <Alert severity="info" sx={{ mb: 3 }}>
        <Typography variant="body2">
          <strong>Last Updated:</strong> July 2025 | <strong>Security Framework:</strong> ISO 27001:2022 Certified
        </Typography>
      </Alert>

      <Typography variant="body1" paragraph>
        HomeLoanMittra takes security seriously. We employ bank-grade security measures to protect your sensitive
        financial information and maintain the highest standards of data protection as required by RBI guidelines and Indian regulations.
      </Typography>
        ...
        <Stack spacing={3}>
          <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
            ...
            <Box>
              ...
              <Typography variant="body2" sx={{ color: '#666' }}>
                All data transmission uses 256-bit SSL/TLS encryption. Data at rest is encrypted using AES-256 encryption
                standards, ensuring your information remains secure throughout its lifecycle.
              </Typography>
            </Box>
          </Box>
          ...
          <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
            ...
            <Box>
              ...
              <Typography variant="body2" sx={{ color: '#666' }}>
                Our infrastructure employs multiple security layers including firewalls, intrusion detection systems,
                DDoS protection, and regular security audits by certified third-party experts.
              </Typography>
            </Box>
          </Box>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(2, 1fr)' }, gap: 3 }}>
          <Box>
            ...
            <Stack spacing={1}>
              ...
              <Typography variant="body2">• Network segregation and isolated environments</Typography>
              <Typography variant="body2">• Vulnerability scanning and penetration testing</Typography>
            </Stack>
          </Box>
      ...
      <Paper elevation={2} sx={{ p: 4 }}>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: 'repeat(2, 1fr)', md: 'repeat(4, 1fr)' }, gap: 2 }}>
          ...
          <Paper elevation={1} sx={{ p: 2, textAlign: 'center', backgroundColor: '#f8f9fa' }}>
            <Typography variant="subtitle2" sx={{ fontWeight: 600, color: '#28a745' }}>
              RBI Guidelines
            </Typography>
            <Typography variant="caption" sx={{ color: '#666' }}>
              NBFC Compliance
      ...
      <Paper elevation={2} sx={{ p: 4 }}>
        ...
        <Stack spacing={2}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            <Typography variant="body2">
              <strong>Detection:</strong> 24/7 monitoring systems for immediate threat identification
            </Typography>
          </Box>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            <Typography variant="body2">
              <strong>Communication:</strong> Transparent notification to affected users and authorities
            </Typography>
          </Box>
      ...
      <Paper elevation={2} sx={{ p: 4 }}>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(2, 1fr)' }, gap: 3 }}>
          <Stack spacing={1}>
            ...
            <Typography variant="body2">• Enable two-factor authentication when available</Typography>
          ...
          <Stack spacing={1}>
            <Typography variant="body2">• Verify website URLs before entering credentials</Typography>
      ...
      <Alert severity="warning" sx={{ mb: 3 }}>
        <Typography variant="body2">
          <strong>Security Incident Reporting:</strong> If you suspect any security incident or unauthorized access to your account,
          please contact our security team immediately at security@homeloanmittra.com or call our 24/7 helpline.
        </Typography>
      </Alert>
      ...
      <Paper elevation={2} sx={{ p: 4, backgroundColor: '#f8f9fa' }}>
        ...
        <Stack spacing={2}>
          <Typography variant="body2">
            <strong>Security Email:</strong> security@homeloanmittra.com
          </Typography>
          <Typography variant="body2">
            <strong>Emergency Hotline:</strong> 1800-XXX-XXXX (24/7)
          </Typography>
          <Typography variant="body2">
            <strong>Response Time:</strong> Critical incidents within 1 hour, non-critical within 24 hours
          </Typography>
          <Typography variant="body2">
      ...
      <Box sx={{ textAlign: 'center', mt: 4 }}>
        <Typography variant="body2" sx={{ color: '#666', fontStyle: 'italic' }}>
          Our security measures are regularly audited and updated to meet evolving threats and regulatory requirements.
        </Typography>
      </Box>
    </Stack>
  );
