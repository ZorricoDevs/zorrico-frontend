  ...
  const loanTypes = [
    {
      ...
      description:
        'Finance your dream home with competitive interest rates and flexible tenure options.',
    ...
    },
    {
      ...
      description:
        'Renovate or improve your existing home with quick approval and minimal documentation.',
      ...
      <Paper elevation={2} sx={{ p: 4 }}>
        ...
        <Box sx={{ mt: 3, p: 2, backgroundColor: '#e3f2fd', borderRadius: 1 }}>
          ...
          <Typography variant='body2' sx={{ color: '#666' }}>
            ...
            <br />
            • Property insurance as per lender requirements
            <br />• Co-applicant may be required based on income
          </Typography>
        </Box>
      </Paper>
